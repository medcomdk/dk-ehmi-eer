...
Alias: $EHMISORRegionType = http://hl7.dk/fhir/core/CodeSystem/dk-core-regional-subdivision-codes
Alias: $EHMISORRegionTypeVS = http://hl7.dk/fhir/core/ValueSet/dk-core-RegionalSubDivisionCodes
