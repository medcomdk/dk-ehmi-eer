/*
Instance: CopyEndpointToEerEndpoint
InstanceOf: StructureMap
Title: "Copy Endpoint to EerMessagingEndpoint"
Description: "Simple StructureMap that copies all fields from one Endpoint to another"
Usage: #definition

* url = "http://medcomehmi.dk/ig/eer/StructureMap/CopyEndpointToEerEndpoint"
* name = "CopyEndpointToEndpoint"
* status = #active
