Instance: MapEerSorEndpointToMessagingEndpoint1
InstanceOf: StructureMap
Title: "Map EER SOR Endpoint to EER Messaging Endpoint"
Description: "Simple StructureMap that copies selected fields from one Endpoint to another"
Usage: #definition
//Description: "Extended StructureMap using variables to map EER SOR Endpoint to EER Messaging Endpoint"

* url = "http://medcomehmi.dk/ig/eer/StructureMap/MapEerSorEndpointToMessagingEndpoint1"
* name = "MapEerSorEndpointToMessagingEndpoint1"
* status = #active
...
* group[=].rule[=].rule[0].name = "copyCoding"
