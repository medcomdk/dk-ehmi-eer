...
Alias: $EdsAuditEventSourceType = http://medcomehmi.dk/ig/dk-ehmi-terminology/CodeSystem/ehmi-auditevent-source-type
Alias: $EdsAuditEventEntityType = http://medcomehmi.dk/ig/dk-ehmi-terminology/CodeSystem/ehmi-auditevent-entity-type
Alias: $EdsAuditEventEntityDetailType = http://medcomehmi.dk/ig/dk-ehmi-terminology/CodeSystem/ehmi-auditevent-entity-detail-type
...
Alias: $EdsAuditEventEntityMessageType = http://medcomehmi.dk/ig/dk-ehmi-terminology/CodeSystem/ehmi-auditevent-entity-message-type
...
Alias: $EerMessagingOrganizationIdentierType = http://medcomehmi.dk/ig/dk-ehmi-terminology/CodeSystem/eer-sor-organization-identier-type
Alias: $EerMessagingOrganizationIdentierTypeVS = http://medcomehmi.dk/ig/dk-ehmi-terminology/ValueSet/eer-sor-organization-identier-type-valueset

Alias: $EerMessageDefinitionIdentifierSystem = http://medcomehmi.dk/ig/dk-ehmi-terminology/CodeSystem/eer-messagedefinition-identifier-system
Alias: $EerMessageDefinitionIdentifierSystemVS = http://medcomehmi.dk/ig/dk-ehmi-terminology/ValueSet/eer-messagedefinition-identifier-system-valueset

Alias: $EerEndpointPayloadType = http://medcomehmi.dk/ig/dk-ehmi-terminology/CodeSystem/ehmi-payload-type
Alias: $EerEndpointPayloadTypeVS = http://medcomehmi.dk/ig/dk-ehmi-terminology/ValueSet/ehmi-payload-type-valueset
...
Alias: $EerSorIOOrganizationType = http://medcomehmi.dk/ig/dk-ehmi-terminology/CodeSystem/eer-sor-io-organization-type
Alias: $EerSorIOOrganizationTypeVS = http://medcomehmi.dk/ig/dk-ehmi-terminology/ValueSet/eer-sor-io-organization-type-valueset
...
Alias: $EerMedComMessageDefinitionType = http://medcomehmi.dk/ig/dk-ehmi-terminology/CodeSystem/eer-medcom-message-definition-type
Alias: $EerMedComMessageDefinitionTypeVS = http://medcomehmi.dk/ig/dk-ehmi-terminology/ValueSet/eer-medcom-message-definition-type-valueset

Alias: $EerSorUnitType = http://medcomehmi.dk/ig/dk-ehmi-terminology/CodeSystem/eer-sor-unit-type
Alias: $EerSorUnitTypeVS = http://medcomehmi.dk/ig/dk-ehmi-terminology/ValueSet/eer-sor-unit-type-valueset

Alias: $EerSorClinicalAdministrativeHierarchy = http://medcomehmi.dk/ig/dk-ehmi-terminology/CodeSystem/eer-sor-clinical-administrative-hierarchy
Alias: $EerSorClinicalAdministrativeHierarchyVS = http://medcomehmi.dk/ig/dk-ehmi-terminology/ValueSet/eer-sor-clinical-administrative-hierarchy-valueset

//Alias: $EerSorMunicipalityCode = http://medcomehmi.dk/ig/dk-ehmi-terminology/CodeSystem/eer-sor-municipality-type
...
Alias: $EerUsageContextCodeSystemVS = http://medcomehmi.dk/ig/dk-ehmi-terminology/ValueSet/eer-messagedefinition-use-context-code-valueset
