...
* id = "EHMI.SOR.OU.L2.HealthcareService.Organization-1.0"
* identifier.value = "EHMI.SOR.OU.L2.HealthcareService.Organization-1.0"
* name = "EHMI.SOR.OU.L2.HealthcareService.Organization-1.0"
