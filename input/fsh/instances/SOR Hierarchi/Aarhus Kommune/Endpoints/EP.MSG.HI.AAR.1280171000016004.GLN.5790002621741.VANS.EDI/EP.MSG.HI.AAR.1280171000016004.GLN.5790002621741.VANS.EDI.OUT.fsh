...
* id = "EP.MSG.HI.AAR.1280171000016004.GLN.5790002621741.VANS.EDI.OUT"
...
* status = #active
* managingOrganization = Reference(Organization/Eer.Sor.HI-AAR-Kommune.1280171000016004)
...
* payloadType[+] = $EerEerMedComMessageDefinitionUri#urn:dk:healthcare:medcom:messaging:edifact:meddis:dis01:d0134l	"Udskrivningsepikrise"
